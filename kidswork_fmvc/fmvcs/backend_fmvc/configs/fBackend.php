...
class fBackend extends fConfigs
{
    ...
    {   
        ...
        $this->fmvc_array->add("datatable_fmvc", "Kidswork\Backend");
        ...
        $this->fmvc_array->add("currency_rates_fmvc", "Kidswork\Backend");
        $this->fmvc_array->add("divisions_fmvc", "Kidswork\Backend");
